...
%  Now we can recover the results by using the handles stored in RES  
%  

%%  Fetch all the results by using fetchOutputs function. 

 yresult= fetchOutputs(RES,'UniformOutput',false );
 
% NOTE: We had to set UniformOutput property to false because the function
% myfourier returns a different dimensioned vector at each invocation.
